...
public class OcatTestContainer extends TestContainer {

    public OcatTestContainer() {
        super();
    ...
    public static class Common extends OcatTestContainer {

        public static final OcatTestContainer.Common INSTANCE = new OcatTestContainer.Common();
